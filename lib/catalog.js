...
export const TEMPLATES = [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Storefront", blurb: "Product grid, collection intro, and a delivery and guarantee strip." },
      { file: "product.html", name: "Product detail", blurb: "Variant and quantity selection, spec table, and a cart drawer held in local state." },
      { file: "about.html", name: "Our story", blurb: "Brand narrative laid out around process imagery." },
      { file: "contact.html", name: "Contact", blurb: "Enquiry form with client-side validation and studio details." },
    ],
    pages: 4,
    features: [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Home", blurb: "Positioning statement, capabilities, and selected work." },
      { file: "work.html", name: "Work", blurb: "Case-study index with filtering by discipline." },
      { file: "about.html", name: "Studio", blurb: "Team, process and credentials." },
      { file: "contact.html", name: "Contact", blurb: "Project brief form with validation and budget ranges." },
    ],
    pages: 4,
    features: [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Landing", blurb: "Hand-drawn SVG app mockup, how-it-works walkthrough, pricing table and FAQ." },
      { file: "changelog.html", name: "Changelog", blurb: "Versioned release notes with type tags and dates." },
    ],
    pages: 2,
    features: [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Gallery", blurb: "Full-bleed grid with a keyboard-navigable lightbox." },
      { file: "case-study.html", name: "Case study", blurb: "Wide imagery interleaved with project narrative." },
      { file: "contact.html", name: "Contact", blurb: "Commission enquiry form and current availability." },
    ],
    pages: 3,
    features: [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Landing", blurb: "Seasonal hero, featured pieces and newsletter capture." },
      { file: "lookbook.html", name: "Lookbook", blurb: "Full-bleed scrolling editorial sequence." },
      { file: "shop.html", name: "Shop", blurb: "Price list grid with sizes and availability." },
    ],
    pages: 3,
    features: [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Journal", blurb: "Essay index with reading times and excerpts." },
      { file: "article.html", name: "Article", blurb: "Long-form layout with pull quotes, footnotes and code blocks." },
      { file: "archive.html", name: "Archive", blurb: "Complete index grouped by year." },
    ],
    pages: 3,
    features: [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Home", blurb: "Hero, opening hours, location and booking prompt." },
      { file: "menu.html", name: "Menu", blurb: "Course sections with prices and dietary marks." },
      { file: "book.html", name: "Booking", blurb: "Date, time and covers form, ready for OpenTable or Resy." },
    ],
    pages: 3,
    features: [
  ...
  },
  {
    ...
    livePreview: true,
    pageList: [
      { file: "index.html", name: "Home", blurb: "Hero, class categories and trainer profiles." },
      { file: "timetable.html", name: "Timetable", blurb: "Filterable weekly schedule by class type and time." },
      { file: "join.html", name: "Membership", blurb: "Plan comparison feeding a preselected join flow." },
    ],
    pages: 3,
    features: [
